/**
 * Interface que estende o objeto Request do Express para incluir informações do payload JWT e, opcionalmente, o ID da escola e do professor.
 *
 ...
 * @property {string} [teacherId] - O identificador do professor associado ao usuário, extraído do token JWT, podendo estar ausente.
 */
